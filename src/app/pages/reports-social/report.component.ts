...
export class ReportComponent implements OnInit {
  ...
  myDate = new Date();
  myDates : any;
  filters : any = { gender: "both", competitionType: "daily", created_at: new Date()};
  audienceFilter :any= { gender: "both", competitionType: "daily", created_at: new Date()};

  // Pie
  public pieChartOptions: ChartOptions = {
    responsive: true,
  };
  public pieChartLabels: Label[] = [ ['Total Click'], ['Social']];
  ...
  ngOnInit() {
    ...
    if(this.router.url == '/social-reports/daily'){
      this.competition_type = 'daily';
    }else if(this.router.url == '/social-reports/special'){
  ...
  private getQuizReports(){
    this.dataService.getQuizSocialReportsName(this.filters).subscribe(quizName => { 
  ...
  private dailyReports()
  {
    ...
    this.dataService.getQuizSocialReports(this.audienceFilter).subscribe(quizReport => { 
