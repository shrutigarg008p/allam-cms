...
@Component({
  ...
  templateUrl: './edit-special-competition.component.html',
  styleUrls: ['./edit-special-competition.component.scss']
})

export class EditSpecialCompetitionComponent implements OnInit {
  ...
  selectedType: any = '';
  narrationType: any = 'live_stareaming';
  showModal: boolean;
  ...
  constructor(private activatedRoute: ActivatedRoute, private fb: FormBuilder, private dcService: DcService, private alertService: ToasterService, private authenticationService: AuthenticationService, private datePipe: DatePipe, private router: Router) {
  ...
  getDailyCompetition(id) {
    ...
    this.dcService.editCompetition(id).subscribe(competition => {
      ...
      if (this.getCompetition.league_date < this.jstoday) {
        this.alertService.pop('error', 'Special Competiton has completed, you can not edit!');
      ...
      var min = arr[1];
      var sec = arr[2];
      console.log(this.getCompetition.narration_type);
      ...
      let realEndDateObject = new Date(this.getCompetition.end_date);
      ...
      this.formVar.patchValue({
        ...
        startDate: this.datePipe.transform(start_date, "yyyy-MM-dd"),
        endDate: this.datePipe.transform(end_date, "yyyy-MM-dd"),
        ...
        switch (event.type) {
          ...
          case HttpEventType.Response:
            ...
            if (event.body.message == 'Record inserted') {
              this.alertService.pop('success', 'Special Competiton updated successfully!');
              this.router.navigate(['/special']);
            } else {
    ...
    $(document).ready(function () {
      ...
      allNextBtn.click(function () { //console.log('hi');
        var curStep = $(this).closest(".setup-content"),
          ...
          curInputs = curStep.find("input[type='text'],input[type='url'],input[type='tel'],input[type='file'],input[type='date'],input[type='time'],textarea,select"),
          isValid = true;
        //console.log('hello');
        $(".form-group").removeClass("has-error");
        for (var i = 0; i < curInputs.length; i++) {
